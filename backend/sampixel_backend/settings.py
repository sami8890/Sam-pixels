...
ROOT_URLCONF = 'sampixel_backend.urls'
...
WSGI_APPLICATION = 'sampixel_backend.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='sampixel'),
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@sampixel.com')
...
CLIPDROP_API_KEY = config('CLIPDROP_API_KEY', default='')
